...
def test_fusion_silu_and_mul_fp8_quant(num_tokens, hidden_size):
    ...
    silu_and_mul_fp8_quant = torch.ops._C.silu_and_mul_fp8_quant.default
    fp8_quant = torch.ops._C.static_scaled_fp8_quant.default

    # In pre-nodes, fp8 quant should be present and fused kernels should not
    assert find_auto_fn_maybe(pre_nodes, silu_and_mul_fp8_quant) is None
    find_auto_fn(pre_nodes, fp8_quant)

    # In post-nodes, fused kernels should be present and fp8 quant should not
    find_auto_fn(post_nodes, silu_and_mul_fp8_quant)
